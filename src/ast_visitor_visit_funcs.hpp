...
virtual void visitInputPortArgSublist(NodeInputPortArgSublist* node) = 0;
virtual void visitOutputPortArgSublist(NodeOutputPortArgSublist* node) = 0;
virtual void visitBidirPortArgSublist(NodeBidirPortArgSublist* node) = 0;
virtual void visitParamArgSublist(NodeParamArgSublist* node) = 0;
virtual void visitOneParamModule(NodeOneParamModule* node) = 0;
...
virtual void visitIdentTermAndExtra(NodeIdentTermAndExtra* node) = 0;
virtual void visitIdentTermAndExtraList(NodeIdentTermAndExtraList* node) = 0;
