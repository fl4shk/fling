...
auto Parser::parse_program() -> ParseRet
{
	...
	const auto seq = _req_or_parse(rsp(package), rsp(module),
		rsp(decl_cstm_type));
...
auto Parser::_parse_kw_modport() -> ParseRet
{
	CHECK_PREFIXED_ONE_TOK(Tok::KwModport);
}
...
auto Parser::_parse_punct_param_pack() -> ParseRet
{
...
auto Parser::_parse_modport() -> ParseRet
{
}
auto Parser::_parse_inner_modport() -> ParseRet
{
}
